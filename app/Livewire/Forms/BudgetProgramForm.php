...
/** Form para gestión de Budget Programs (Programas Presupuestales). */
class BudgetProgramForm extends BaseForm
{
    public ?string $code = '';
   ...
   // public ?string $description = '';
    ...
    public function rules(): array
    {
        ...
        return [
            'code' => ['required', 'string', 'min:1', 'max:10', 'regex:/^[A-Z0-9-]+$/', Rule::unique('budget_programs', 'code')->ignore($id)->whereNull('deleted_at')],
            'name' => ['required', 'string', 'min:3', 'max:255', Rule::unique('budget_programs', 'name')->ignore($id)->whereNull('deleted_at')],
    ...
    {
        return $this->only(['code', 'name', 'is_active']);
    }
}
