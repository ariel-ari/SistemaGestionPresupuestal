...
/** Form para gestión de Activities (Actividades Presupuestales). */
class ActivityForm extends BaseForm
{
    ...
    public function rules(): array
    {
        ...
        return [
            //'code' => ['required', 'string', 'min:1', 'max:10', 'regex:/^[A-Z0-9-]+$/', Rule::unique('activities', 'code')->ignore($id)->whereNull('deleted_at')],
            'name' => ['required', 'string', 'min:3', 'max:255', Rule::unique('activities', 'name')->ignore($id)->whereNull('deleted_at')],
