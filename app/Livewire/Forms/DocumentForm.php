...
/** Form para gestión de Documents (Documentos Presupuestales). */
class DocumentForm extends BaseForm
{
   // public ?string $code = '';
   ...
   // public ?string $description = '';
    ...
    public function rules(): array
    {
        ...
        return [
           // 'code' => ['required', 'string', 'min:1', 'max:10', 'regex:/^[A-Z0-9-]+$/', Rule::unique('documents', 'code')->ignore($id)->whereNull('deleted_at')],
            'name' => ['required', 'string', 'min:3', 'max:255', Rule::unique('documents', 'name')->ignore($id)->whereNull('deleted_at')],
